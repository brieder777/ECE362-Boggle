...
${OBJECTDIR}/course_includes/lcddriver.o: course_includes/lcddriver.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/course_includes/lcddriver.o course_includes/lcddriver.c

${OBJECTDIR}/course_includes/termio.o: course_includes/termio.c 
	${MKDIR} -p ${OBJECTDIR}/course_includes
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/course_includes/termio.o course_includes/termio.c

${OBJECTDIR}/dictionary/spi_flash.o: dictionary/spi_flash.c 
	${MKDIR} -p ${OBJECTDIR}/dictionary
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dictionary/spi_flash.o dictionary/spi_flash.c

${OBJECTDIR}/display/vga2.o: display/vga2.asm 
	${MKDIR} -p ${OBJECTDIR}/display
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/display/vga2.o display/vga2.asm

${OBJECTDIR}/game_logic/boggle.o: game_logic/boggle.c 
	${MKDIR} -p ${OBJECTDIR}/game_logic
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_logic/boggle.o game_logic/boggle.c
